...
class CreateHnfeiTable extends Migration
{
    public function up()
    {
        Schema::create('boostech_nfe_hnfei', function (Blueprint $table) {
            ...
            $table->string('prod_cprod', 60)->nullable(false);
            $table->string('prod_cean', 14)->nullable(false);
            $table->string('prod_xprod', 120)->nullable(false);
            $table->string('prod_ncm', 8)->nullable(false);
            $table->string('prod_ex_tipi', 3)->nullable(false);
            $table->string('prod_cfop', 4)->nullable(false);
            $table->string('prod_ucom', 6)->nullable(false);
            $table->float('prod_qcom', 15, 4)->nullable(false);
            $table->float('prod_vuncom', 20, 10)->nullable(false);
            $table->float('prod_vprod', 15, 2)->nullable(false);
            $table->string('prod_ceantrib', 14)->nullable(false);
            $table->string('prod_utrib', 6)->nullable(false);
            $table->float('prod_qtrib', 11, 4)->nullable(false);
            $table->float('prod_vuntrib', 20, 10)->nullable(false);
            ...
            $table->string('prod_indtot', 1)->nullable(false);
