...
class CreateHnfexTable extends Migration
{
    public function up()
    {
        Schema::create('boostech_nfe_hnfex', function (Blueprint $table) {
            ...
            $table->string('emit_cpf', 14);
            $table->string('emit_xnome', 60);
            $table->string('emit_xfant', 60);
            ...
            $table->string('enderemit_xcpl', 60);
            ...
            $table->string('enderemit_cpais', 4);
            $table->string('enderemit_xpais', 60);
            $table->string('enderemit_fone', 14);
            ...
            $table->string('dest_ie', 14);
            $table->string('dest_isuf', 9);
            $table->string('dest_im', 15);
            $table->string('dest_email', 500);

            $table->string('enderdest_xlgr', 60);
            $table->string('enderdest_nro', 60);
            $table->string('enderdest_xcpl', 60);
            $table->string('enderdest_xbairro', 60);
            $table->string('enderdest_cmun', 7);
            $table->string('enderdest_xmun', 60);
            $table->string('enderdest_uf', 2);
            $table->string('enderdest_cep', 8);
            $table->string('enderdest_cpais', 4);
            $table->string('enderdest_xpais', 60);
            $table->string('enderdest_fone', 14);

            $table->float('total_vprod', 15, 2);

            $table->bigInteger('vol_qvol');
            $table->string('vol_esp', 60);
            $table->string('vol_marca', 60);
            $table->string('vol_nvol', 60);
            $table->float('vol_pesol', 15, 32);
            $table->float('vol_pesob', 15, 32);
